                    ...
                    <form action="{{ route('marchand.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="nom_marchand" class="form-control" placeholder="Nom">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName1">prenom</label>
                                <input type="text" name="prenom_marchand" class="form-control" placeholder="Prenom">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="adresse_marchand" class="form-control" placeholder="Adresse">
                            </div>
                        </div>
                        <!-- /.card-body -->
